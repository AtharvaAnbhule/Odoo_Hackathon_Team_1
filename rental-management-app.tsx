      ...
      <section className="relative">
        ...
        <div className="relative px-8 py-16 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Rent Anything, Anytime</h1>
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Professional rental management platform for equipment, tools, and more
            </p>
      ...
      <section className="grid md:grid-cols-3 gap-8">
        <Card className="text-center">
          <CardHeader>
            ...
            <CardDescription>Choose from thousands of quality products across multiple categories</CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card className="text-center">
          <CardHeader>
            ...
            <CardDescription>Simple booking process with flexible pickup and return options</CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card className="text-center">
          <CardHeader>
            ...
            <CardDescription>Professional service with maintenance and support included</CardDescription>
          </CardHeader>
        </Card>
      </section>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        {currentPage === "products" && <ProductCatalog onBookProduct={handleBookProduct} />}
      </main>
    </div>
  )
}
