...
export default function AdminProductsPage() {
  ...
  const getStockStatus = (stock: number, totalStock: number) => {
    ...
    if (ratio > 0.7) return { color: "bg-green-100 text-green-800", text: "In Stock" }
    if (ratio > 0.3) return { color: "bg-yellow-100 text-yellow-800", text: "Limited" }
    if (ratio > 0) return { color: "bg-red-100 text-red-800", text: "Low Stock" }
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                <strong>Base Price:</strong> ₹{product.basePrice} per {product.unit}
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                ...
                {product.lastMaintenance ? new Date(product.lastMaintenance).toLocaleDateString() : "N/A"}
              </div>
            </div>
          </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage your rental inventory and product catalog</p>
          </div>
          <Button>
